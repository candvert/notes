...
4. BPMN（Business Process Model and Notation，业务流程模型与符号）：BPMN是一种业务流程建模和标记语言，用于描述企业流程。它提供了一系列的符号和语法，使得开发人员可以更好地描述复杂的业务流程。
5. ArchiMate：ArchiMate是一种企业架构建模语言，用于描述企业的结构和行为。它提供了一系列的符号和语法，能够很好地帮助开发人员描述企业架构。
6. SysML（Systems Modeling Language，系统建模语言）
```
